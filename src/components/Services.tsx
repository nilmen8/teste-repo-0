  ...
  const services = [
    {
      title: "Web",
      description:
        "Desenvolvimento de sites e sistemas web estáticos e dinâmicos com React.js, Next.js, HTML E CSS3.",
    ...
    <section className="container mx-auto my-12 max-w-4xl p-4">
      <div className="p-4 text-center">
        ...
        <p className="text-sm text-gray-600">
          Posso atender uma gama completa de serviços, do front-end ao beck-end
